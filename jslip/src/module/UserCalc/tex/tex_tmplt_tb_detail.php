        ...
        for ($i = 0; $i < $cnt; $i++) {
            ...
            switch ($rec[0]) {
                ...
                case "field":
                    ...
                    $this->dat[$rec[0]]["item"]          = trim($rec[6]);
                    $this->dat[$rec[0]]["debit_remain"]  = trim($rec[7]);
                    $this->dat[$rec[0]]["debit_sum"]     = trim($rec[8]);
                    $this->dat[$rec[0]]["name"]          = trim($rec[9]);
                    $this->dat[$rec[0]]["credit_sum"]    = trim($rec[10]);
                    $this->dat[$rec[0]]["credit_remain"] = trim($rec[11]);
                    break;
                case "data":
                    ...
                    $this->dat[$rec[0]][$data_n]["item"]          = trim($rec[6]);
                    $this->dat[$rec[0]][$data_n]["debit_remain"]  = trim($rec[7]);
                    $this->dat[$rec[0]][$data_n]["debit_sum"]     = trim($rec[8]);
                    $this->dat[$rec[0]][$data_n]["name"]          = trim($rec[9]);
                    $this->dat[$rec[0]][$data_n]["credit_sum"]    = trim($rec[10]);
                    $this->dat[$rec[0]][$data_n]["credit_remain"] = trim($rec[11]);
                    $data_n++;
                    break;
            }
        }
