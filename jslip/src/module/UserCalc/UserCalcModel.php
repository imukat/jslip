    ...
    private function _calc_slip() {
        ...
        try {
            ...
            $qry =  "INSERT INTO `w_slip`"
                 ...
                 .   " CAST((`s`.`debit`  / 100) AS INTEGER)" . " AS `debit_account`,"  // 借方勘定科目
                 .   " CAST((`s`.`credit` / 100) AS INTEGER)" . " AS `credit_account`," // 貸方勘定科目
                 .   " CASE"
    ...
    private function _calc_account() {
        ...
        try {
            ...
            $qry =  "INSERT INTO `w_account`"
                 ...
                 .   " `i`.`item`"      . " AS `item`,"
                 .   " CAST((`i`.`kcd` / 100) AS INTEGER)" . " AS `account_cd`,"
                 .   " `i`.`kcd`"       . " AS `item_cd`,"
    ...
    private function _calc_tb() {
        ...
        try {
            ...
            $qry = "INSERT INTO `w_tb_c`"
                 ...
                 .   " END                 AS `remain`"
                 .  ", CAST((`a`.`item` / 100000) AS INTEGER) * 10  AS `ctg3`"
                 .  ", CAST((`a`.`item` /  10000) AS INTEGER)       AS `ctg4`"
                 . " FROM"
            ...
            $qry = "INSERT INTO `w_tb_rslt1`"
                 ...
                 .  ", `i`.`div`                  AS `ctg_div`"
                 .  ", CAST((`c`.`ctg3` / 1000) AS INTEGER) * 1000 AS `ctg1`"
                 .  ", CAST((`c`.`ctg3` /  100) AS INTEGER) *  100 AS `ctg2`"
                 .  ", `c`.`ctg3`                 AS `ctg3`"
                 .  ", `c`.`ctg4`                 AS `ctg4`"
                 .  ", CAST((`c`.`item` /  100) AS INTEGER) %  100 AS `ctg5`"
                 . " FROM"
